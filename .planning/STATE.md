...
Last activity: 2026-06-10 - Completed quick task 260610-ed7: fixed the relayer Privy verifier env-var bug (read NEXT_PUBLIC_PRIVY_APP_ID, not stale PRIVY_APP_ID) that was 401-ing every valid token and blocking ALL sign-in — needs operator flyctl relayer redeploy to go live (soak already closed out by 260610-dp6, so redeploy is safe)
