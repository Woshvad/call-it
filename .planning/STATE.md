...
Last activity: 2026-06-10 - Completed quick task 260610-ev0: restyled the CONNECT SOCIALS onboarding screen button hierarchy (Link Farcaster→filled yellow, Continue→outlined, Skip for now→plain muted text) — cosmetic, 2 files, committed 220a701, not pushed (operator deploys web via Vercel)
