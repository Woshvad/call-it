...
Last activity: 2026-06-11 -- Completed quick task 260611-uf9: trivially-true call guard (priceTarget target must be strictly above live Pyth price; web composer inline gate + relayer preflight fail-closed enforcement). Earlier today: u1l live card redesign, tbc settled card redesign + feed enrichment (deployed), sof subgraph globalRep fix (v0.9.2), t7h feed tabs+chips.
