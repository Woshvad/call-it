...
Last activity: 2026-06-10 -- Completed quick task 260610-vab: CI Playwright gate made real (workflow had never run; whole suite now gating, verified green) + 260610-sr0 relayer fix DEPLOYED to Fly with 3 secrets (feed live; Upstash quota = settlement DOWN, operator decision)
