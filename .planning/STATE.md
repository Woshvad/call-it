...
Last activity: 2026-06-11 -- Completed quick task 260611-bf2: web publish path fixed (3 stacked bugs; never worked end-to-end). Relayer redeployed earlier today (260611-5mh enrichment live). Remaining operator items: Upstash quota (settlement DOWN + subgraph 429 storms), user re-link Twitter to active wallet, user retry publish.
