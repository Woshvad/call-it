...
Last activity: 2026-06-11 -- Completed fast task 260611-fast-awaiting-actions: FOLLOW/FADE/CHALLENGE hidden on awaiting-settlement feed cards (D-08 dead controls). Earlier today: uf9 trivially-true call guard (web+relayer, relayer side awaits Fly deploy), u1l live card redesign, tbc settled card redesign + feed enrichment (deployed), sof subgraph globalRep fix (v0.9.2).
