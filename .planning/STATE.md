...
Last activity: 2026-06-11 -- Completed quick task 260611-hog: composer asset dropdown (24 allowlisted assets, 6 groups) + live Hermes price row + price-target % chips (+10/+20/+50/+100). Earlier today: h44 receipt honesty fixes (full f7c design review closed), fo1 follow/fade approve fix; MILESTONE: full web publish path WORKS live; relayer redeployed (co5 enum map + RPC fallbacks). Still pending: Upstash quota (operator; settlement worker DOWN), Alchemy key monthly capacity exhausted (public-RPC failover live in web+relayer).
