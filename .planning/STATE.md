...
Last activity: 2026-06-09 - Completed quick task 260609-s7f: /signin now self-heals a split-brain/stale Privy session (auto logout + cookie-clear when authenticated-but-no-token) so users can't get stranded with dead sign-in buttons
