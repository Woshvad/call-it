...
Last activity: 2026-06-11 -- Completed quick task 260611-co5: composer publish wired (AA stub replaced with direct wagmi writes; CR-01 enum-drift fix means relayer needs redeploy for fixed shared map). Full publish path now: preflight 200 (bf2) -> gas guard -> approve -> createCall. User action needed: faucet Sepolia ETH to 0x73047a88...2c5CeD, then publish. Operator: Upstash quota.
