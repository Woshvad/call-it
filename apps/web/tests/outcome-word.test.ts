/**
 * outcome-word.test.ts — GREEN-gate Vitest tests for outcome word assignment.
 *
 ...
 *
 * MOVED from apps/relayer/src/workers/__tests__/outcome-word.test.ts to apps/web/tests/
 * to resolve cross-package rootDir violation (relayer tsconfig rootDir = apps/relayer/src,
 * cannot legitimately import apps/web source). Co-location approach: outcome-word is display
 * logic used by the web page + OG routes; web/tests/ is the natural home (Plan 04-07).
 *
